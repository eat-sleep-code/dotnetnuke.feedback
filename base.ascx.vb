			...
			Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
				...
				Try
					If Not IsPostBack Then
						...
						Catch ex As Exception
							Try
								txt_sender_email.Text = obj_user_info.Email
						...
						Try
							txt_sender_name.Text = obj_user_info.Profile.FullName
						Catch ex As Exception
							'//
						End Try
...
'//*** 05.01.00 BETA BREAKS THE FOLLOWING ***********************************************************************************************************************************				
				'Try
				'	'txt_body.ChooseMode = False
				'Catch ex As Exception
				'	'// 
				'End Try
'//*** 05.01.00 BETA BREAKS THE PRECEDING ***********************************************************************************************************************************
